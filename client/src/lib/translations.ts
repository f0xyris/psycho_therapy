...
export const translations: Record<Language, Translations> = {
  uk: {
    ...
    modernEquipment: "Доказові методи",
    modernEquipmentDesc: "Транзакційний аналіз, інтегративна психотерапія з фокусом на стосунки та DBT.",
    experiencedSpecialists: "Ліцензований психотерапевт",
    experiencedSpecialistsDesc: "Постійно вдосконалююсь та проходжу супервізії та інтервізії.",
